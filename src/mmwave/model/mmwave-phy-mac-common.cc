...
MmWavePhyMacCommon::MmWavePhyMacCommon (): 
	m_symbolsPerSlot (30),          // IAB: not used 
	m_symbolPeriod (4.16),
	...
	m_dlCtrlSymbols (1),
	m_ulCtrlSymbols (1),
	m_slotsPerSubframe (8),         // IAB: not used
	...
	m_chunksPerRb (72),
	m_numRefScPerRb (6),
	m_numRefScPerSym (864),         // 864 = 72 * 48 / 4; the total number of reference subcarriers is 1/4th of the total subcarriers.
	m_chunkWidth (13.889e6),
	m_numRb (1),
	m_numHarqProcess (20),
	m_harqTimeout (20),
