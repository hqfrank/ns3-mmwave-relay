...
/*
 * This program is to simulate a simple relay-assisted mmWave network with three logical links.
 * 
 *  ------iab------iab------ue
 *  | 
 * enb------iab------iab------ue
 ...
 * 3 mmwave-ue nodes are placed at the end of all three logical links.
 */
...
main (int argc, char *argv[])
{
    ...
    uint32_t numRelays = 9;            // # of IAB nodes
    uint32_t numLogicalLinks = 3;      // # of logical links in the network
