...
main (int argc, char *argv[])
{
    ...
    uint32_t interPacketInterval = 100; // micro-second, us
    ...
    Config::SetDefault ("ns3::MmWaveSpectrumPhy::DataErrorModelEnabled", BooleanValue (false));
    ...
    Vector posIab7 = Vector(x[numBuildingsColumn/2], y[numBuildingsRow/2 - 1], gnbHeight);
    Vector posIab8 = Vector(x[numBuildingsColumn/2 - 1], y[numBuildingsRow/2 - 1], gnbHeight);
    Vector posIab9 = Vector(x[numBuildingsColumn/2 - 1], y[numBuildingsRow/2 - 2], gnbHeight);
    Vector posUe3 = Vector(x[numBuildingsColumn/2 - 2], y[numBuildingsRow/2 - 2], gnbHeight);
    Vector posIab10 = Vector(x[numBuildingsColumn/2 - 1], y[numBuildingsRow/2], gnbHeight);
    Vector posIab11 = Vector(x[numBuildingsColumn/2 - 1] - 3, y[numBuildingsRow/2 + 1], gnbHeight);
    Vector posIab12 = Vector(x[numBuildingsColumn/2 - 2] - 4, y[numBuildingsRow/2 + 1], gnbHeight);
    Vector posUe4 = Vector(x[numBuildingsColumn/2 - 2], y[numBuildingsRow/2 + 2] + 4, gnbHeight);
